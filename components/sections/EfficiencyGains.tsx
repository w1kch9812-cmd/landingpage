...
import styles from './EfficiencyGains.module.css';
...
export default function EfficiencyGains() {
  return (
    <section id="section-efficiency" className={styles.section}>
      <div className={styles.container}>
        ...
        <FadeUp>
          <SectionHeader
            ...
            sectionNumber="06"
            description="발품 팔고, 전화 돌리고, 엑셀 정리하던 시간을 아끼세요. 공짱이 모든 정보를 한 곳에 모아 비교·분석해 드립니다."
          >
            시간은 줄이고,<br />
            효율은 높이고
          </SectionHeader>
